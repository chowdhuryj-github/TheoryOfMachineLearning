...
Create a Jupyter notebook named lab02 in the code directory. The notebook should have a title, your name, and an introduction that describes what will be covered in the lab.
...
All written code (the lab notebook) should be placed in the code folder and pushed. Upload the PDF of the notebook through Canvas (as backup if needed - not required).
